...
ALLOWED_HOSTS = ['localhost', 'localhost:8000', '127.0.0.1', '134.209.108.83',
                 '134.209.108.83:8000',  env('SERVER', default='127.0.0.1')]
CSRF_TRUSTED_ORIGINS = ['http://localhost:8000', 'http://127.0.0.1', '134.209.108.83:8000', 'https://' + env('SERVER', default='127.0.0.1') ]
